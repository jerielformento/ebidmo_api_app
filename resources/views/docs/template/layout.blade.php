          ...
          <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="position-sticky pt-3">
              <ul class="nav flex-column">
                <li class="nav-item">
                  <a class="nav-link" aria-current="page" href="/api-docs"><span data-feather="home"></span> Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/api-docs/auth"><span data-feather="home"></span> Authentication</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/api-docs/customer"><span data-feather="home"></span> Customer</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/api-docs/product"><span data-feather="home"></span> Product</a>
                </li>
                <li class="nav-item">
